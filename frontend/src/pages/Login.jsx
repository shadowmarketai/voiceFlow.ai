...
function GoogleSignInButton({ onSuccess, disabled }) {
  ...
  return (
    <button
      ...
      className="w-full px-5 py-2.5 rounded-xl bg-white hover:bg-gray-50 border border-gray-200 text-slate-700 text-sm font-medium transition-all flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
    >
